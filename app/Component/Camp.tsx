...
const CampSite=({backgroundImage,title,subtitle,peopleJoined}:CampProps)=>{
    return (
        <div className={`h-full w-full min-w-[110px] ${backgroundImage}
        ...
        <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
            ...
            xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
                    ...
                    <p className="regular-14 xl:regular-16 mt-5 text-white">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Esse, deserunt. Debitis dolore corporis totam ipsum assumenda molestiae ducimus nulla velit, dicta, maxime distinctio rerum maiores necessitatibus culpa, porro dolorum non.
                    </p>
                    <Image
                    src="/quote.svg"
                    alt="camp-2"
